...
const LandingPage = () => {
  ...
  useEffect(() => {
    ...
    document
      .querySelectorAll(".animate-on-scroll, .feature-card, .testimonial-card")
      .forEach((element) => {
      ...
      <div className="landing-page absolute top-0 left-0">
        ...
        >
          <div className="max-w-full mx-auto px-4 sm:px-6 lg:px-8">
            <div className="lg:grid lg:grid-cols-12 lg:gap-8">
              <div className="lg:col-span-6">
                <div className="mt-12 lg:mt-24">
                  ...
                  <motion.div variants={staggerItem}>
                    <TextType
                      text={[
                        "NeighbourLink is a hyperlocal platform that helps you share resources,",
                        "find urgent assistance,",
                        "and build a stronger community—all within your neighborhood.",
                      ]}
                      typingSpeed={75}
                      pauseDuration={1500}
                      showCursor={true}
              ...
              <div className="mt-12 lg:mt-0 lg:col-span-6"></div>
            </div>
          </div>
        </motion.div>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <motion.div variants={fadeInUp} className="text-center">
              ...
              <p className="mt-4 max-w-2xl mx-auto text-xl text-white/80 drop-shadow-md">
                NeighbourLink makes it easy to connect with your neighbors and
                share resources.
              </p>
            </motion.div>
            ...
            >
              ...
              >
                ...
                <p className="text-white/80 drop-shadow-sm">
                  Share underutilized items like tools, medical equipment, or
                  books with trusted neighbors.
                </p>
              </motion.div>
              ...
              >
                ...
                <p className="text-white/80 drop-shadow-sm">
                  Broadcast urgent needs to neighbors within a 2km radius via
              ...
              >
                ...
                >
                  <img
                    src="/assets/secure_communication.png"
                    className=""
                    alt=""
                  />
                </motion.div>
                ...
                <p className="text-white/80 drop-shadow-sm">
                  Chat privately with neighbors using our end-to-end encrypted
                  messaging system.
                </p>
              </motion.div>
              ...
              >
                ...
                <p className="text-white/80 drop-shadow-sm">
                  Earn "Trusted Neighbor" badges through ID verification and
              ...
              >
                ...
                <p className="text-white/80 drop-shadow-sm">
                  Connect with neighbors within 1-5km radius, creating a truly
              ...
              >
                ...
                <p className="text-white/80 drop-shadow-sm">
                  Coordinate safe pickup locations and maintain privacy with
            ...
            <div className="mt-16">
              <div className="lg:grid lg:grid-cols-3 lg:gap-8">
                ...
                <motion.div variants={staggerItem} className="text-center">
                  ...
                  <h3 className="mt-8 text-lg font-bold text-white drop-shadow-md">
                    Sign Up & Verify
                  </h3>
                  <p className="mt-5 text-base font-light text-white/80 drop-shadow-sm">
                    Create an account using your phone number or email, then
                    verify your identity to earn a "Trusted Neighbor" badge.
                  </p>
                </motion.div>
                ...
                >
                  ...
                  <p className="mt-5 text-base font-light text-white/80 drop-shadow-sm">
                    Post requests or offers for resources, or search for items
                    you need within your neighborhood radius (1-5km
                    customizable).
                  </p>
                </motion.div>
                ...
                >
                  ...
                  <p className="mt-5 text-base font-light text-white/80 drop-shadow-sm">
                    Communicate through secure messaging, arrange meetups at
                    safe locations, and start building relationships with your
                    neighbors.
                  </p>
                </motion.div>
              </div>
        ...
        >
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <motion.div variants={fadeInUp} className="text-center">
              ...
              <p className="mt-4 max-w-2xl mx-auto text-xl text-white/80 drop-shadow-md">
                Real stories from people using NeighbourLink to build stronger
                communities
              </p>
            </motion.div>
            ...
            <div className="mt-16 grid gap-8 md:grid-cols-2 lg:grid-cols-3">
              ...
              >
                ...
                <p className="text-white/80 italic drop-shadow-sm">
                  "When my son needed crutches after a sports injury, I posted
                  an urgent request on NeighbourLink. Within 30 minutes, a
                  neighbor three blocks away offered to lend us a pair. We saved
                  hundreds of dollars and made a new friend!"
                </p>
              ...
              >
                ...
                <p className="text-white/80 italic drop-shadow-sm">
                  "During the last power outage, NeighbourLink's emergency alert
                  system helped our street coordinate sharing generators and
                  refrigerator space. It turned a stressful situation into a
                  block party!"
                </p>
                <div className="mt-4 flex text-yellow-400 drop-shadow-sm">
                  <i className="fas fa-star"></i>
              ...
              >
                ...
                <p className="text-white/80 italic drop-shadow-sm">
                  "As a new mom working from home, I felt isolated until I found
                  NeighbourLink. I've borrowed baby equipment, found a
                  babysitting swap, and finally feel connected to my
                  neighborhood after living here for years."
                </p>
                <div className="mt-4 flex text-yellow-400 drop-shadow-sm">
                  <i className="fas fa-star"></i>
                  <i className="fas fa-star"></i>
        ...
        >
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <motion.h2
              variants={fadeInUp}
              className="text-3xl font-extrabold sm:text-4xl drop-shadow-lg"
            >
              Ready to connect with your community?
            </motion.h2>
            <motion.p
              variants={fadeInUp}
              className="mt-4 max-w-2xl mx-auto text-xl text-white/80 drop-shadow-md"
            >
              Download NeighbourLink today and start building relationships with
              your neighbors.
            </motion.p>
